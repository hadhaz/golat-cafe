...
export default function Main() {
  return (
    <div className='max-w-7xl w-screen overflow-hidden mx-auto grid grid-cols-5'>
      <section className='col-span-2 flex flex-col gap-y-8 p-6 px-12'>
        ...
        <p className='w-[90%] lg:w-[75%] hover:scale-105 duration-300'>
          “Coworking is all about community, but I believe the &apos;work&apos;
          part of coworking should be as attractive as the &apos;co&apos; part.”
        </p>
        <Link href='/reserve'>
